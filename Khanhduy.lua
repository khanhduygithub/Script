---------------------------------------------------------------------------------------
--Hello Bro. Not Delete Credit To Respect The Author.
--If Deliberately Delete This Line The Script Won't Run.
--Chào Bạn. Vuu Lòng Không Xoá Dòng Này Để Tôn Trọng Tác Giả,
--Nếu Cố Tình Xoá Script Sẽ Không Chạy
--Telegram: @levanhat_hebi | https://t.me/wasteamstudio
--Discord: levannhat
--Note: Crack Share By Lê Văn Nhất (Nhất Đang Chán IT)
--Tao Bảo Thật Script Mày Như Lồn Vậy Mới Bị T Dec :))
---------------------------------------------------------------------------------------
...
local UiLibruyd = Instance.new('ScreenGui')
UiLibruyd.Parent = game.CoreGui
local LibraryFix = Instance.new('TextLabel')
LibraryFix.Parent = cac
LibraryFix.BackgroundTransparency = 1
LibraryFix.TextSize = 25
LibraryFix.Text = '\78\104\97\116\68\97\110\103\67\104\97\110\73\84\32\124\32\64\108\101\118\97\110\104\97\116\95\104\101\98\105\10'
LibraryFix.TextColor3 = Color3.fromRGB(255,255,255)
LibraryFix.Size = UDim2.new(1,0,1,5,0) 
